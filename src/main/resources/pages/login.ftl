    ...
    <div class="my-3 px-4 px-sm-5 pb-3 pb-sm-4 pt-4 pt-sm-36p border rounded shadow-sm">
        ...
        <div class="row text-center">
            <div class="col-sm-2 p-0">
                <span>
                    <img alt="GBIF" style="height: 50px;" src="/images/gbif-logo.svg"/>
                </span>
            </div>
...
<#--            <input type="hidden" name="csrfToken" value="${newCsrfToken!}">-->
            ...
            <div class="row g-3 mt-0 mb-2">
                <div class="col-12">
                    ...
                    <input class="form-control" type="text" id="email" name="email" value="${email!"mpodolskiy@gbif.org"}" placeholder="${userEmail}">
                </div>
